...
export const searchAbhaByMobile = "/v3/hip/verification/abha/searchByMobile";
export const profileLoginRequestOtp = "/v3/hip/verification/abha/profileLoginRequestOtp";
export const profileLoginVerify = "/v3/hip/verification/abha/profileLoginVerify";
