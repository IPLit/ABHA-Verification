...
const AadhaarConsent = (props) => {
    ...
    const AadhaarConsents = [
        ...
        "I consent to usage of my ABHA address and ABHA number for linking of my legacy health records and those which will be generated during this encounter.",
        ...
        "I consent to the anonymization and subsequent use of my past health records for public health purposes.",
